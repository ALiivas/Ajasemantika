...
predict_on_corpus(model=model, 
                  tokenizer=tokenizer, 
                  layer='gold_word_events_w_agg_classes', 
                  event_classes=event_classes,
                  corpus_path='masters_thesis/model_data/TempFact/rkogu/', 
                  pred_results_filename='estbert_events_w_agg_class_param_tuning_pred_tempf_rkogu'
                  )