...
def save_predictions(target_path, corpus_texts, sentence_starts, tokens_w_spans, pred_tag_values):
...
def predict_on_corpus(corpus_path, dtype, model, tokenizer, layer, event_classes):
    ...
    #with open(f'masters_thesis/est-roberta_events_param_tuning_pred_tempf_{dtype}.json', 'w') as f: 
