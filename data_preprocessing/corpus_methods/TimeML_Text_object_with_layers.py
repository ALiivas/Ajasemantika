...
def create_gold_word_events_layer(text_obj, sentence_base_annotations):
...
def create_Text_object_with_layers(filename, articlesDCT, baseAnnotations, eventsByLoc, timexesByLoc, event_timex_relations, event_dct_relations):
    ...
    text_obj.add_layer( create_gold_word_events_layer(text_obj, sentence_base_annotations) )
